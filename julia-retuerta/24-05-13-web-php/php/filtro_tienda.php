...
<section class="categorias">
    ...
    <div class="categorias__bloque">
        <div class="categorias__card">
            <a class="categorias__foto" href="./tienda.php?cat=mujer"><img src="./images/cat-mujer.jpeg" alt=""></a>
            <a class="categorias__btn" href="./tienda.php?cat=mujer"><h3>COMPRAR PARA MUJER</h3></a>
        </div>
        <div class="categorias__card">
            <a class="categorias__foto" href="./tienda.php?cat=hombre"><img src="./images/cat-hombre.jpeg" alt=""></a>
            <a class="categorias__btn" href="./tienda.php?cat=hombre"><h3>COMPRAR PARA HOMBRE</h3></a>
        </div>
        <div class="categorias__card">
            <a class="categorias__foto" href="./tienda.php?cat=infantil"><img src="./images/cat-infantil.jpeg" alt=""></a>
