<section class="productos">
    <h2 class="productos__titulo">INFANTIL</h2>
    <div class="productos__bloque">
        <!--PRODUCTO 1-->
        <div class="productos__card">
            <a href="./producto.php"><img src="./images/infantil1.jpeg" alt=""></a>
        ...
        <!--PRODUCTO 2-->
        <div class="productos__card">
            <a href="./producto.php"><img src="./images/infantil2.webp" alt=""></a>
            <div class="productos__detalle">
        ...
        <!--PRODUCTO 3-->
        <div class="productos__card">
            <a href="./producto.php"><img src="./images/infantil3.jpeg" alt=""></a>
            <div class="productos__detalle">
        ...
        <!--PRODUCTO 4-->
        <div class="productos__card">
            <a href="./producto.php"><img src="./images/infantil4.jpeg" alt=""></a>
            <div class="productos__detalle">
                <h3 class="productos__nombre">Jeans rectos costuras marcadas</h3>
