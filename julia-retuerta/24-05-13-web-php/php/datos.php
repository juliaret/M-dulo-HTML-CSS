...
$to="julia.retuertanogales@alumnostrazos.net";
$subject =$asunto;
$message = '
<!DOCTYPE html>
<html lang="es">
...
if(mail($to,$subject,$message,$headers)){
    ...
    header("Location:http://localhost:8888/julia-retuerta/24-05-13-web-php/contacto.php?respuesta=Algo ha fallado. Inténtalo más tarde");
}
